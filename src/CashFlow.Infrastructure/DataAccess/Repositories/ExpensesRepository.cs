...
namespace CashFlow.Infrastructure.DataAccess.Repositories
{
    internal class ExpensesRepository : IExpensesWriteOnlyRepository, IExpensesReadOnlyRepository, IExpensesUpdateOnlyRepository
    {
        ...
        public async Task<List<Expense>> Read()
        {
        ...
        async Task<Expense?> IExpensesReadOnlyRepository.ReadAt(long id)
        {
            return await _dbContext
                .Expenses
                .AsNoTracking()
        ...
        async Task<Expense?> IExpensesUpdateOnlyRepository.ReadAt(long id)
        {
